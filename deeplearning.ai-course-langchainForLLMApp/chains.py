...
if LLM_CHAIN:
    prompt = ChatPromptTemplate.from_template(
        "What is the best name to descbribe \
...
if SEQUENTIAL_CHAIN:
    review = "Je trouve le goût médiocre. La mousse ne tient pas,\
        c'est bizarre. J'achète les mêmes dans le commerce et\
        le goût est bien meilleur... Vieux lot ou contrefaçon!?"
